...
<img src="https://github.com/llada60/Real-Time-Hand-Gesture-and-Face-Recognition-for-adaptive-game-control/blob/main/img/hand_landmark.png" width="500px">
...
<div style="display: flex; gap: 10px; align-items: center;">
  <img src="https://github.com/llada60/Real-Time-Hand-Gesture-and-Face-Recognition-for-adaptive-game-control/blob/main/img/fingertip.gif?raw=true" width="300px" height="500px">
  <img src="https://github.com/llada60/Real-Time-Hand-Gesture-and-Face-Recognition-for-adaptive-game-control/blob/main/img/yeah.gif?raw=true" width="300px" height="600px">
</div>

### Game Control with facial expressions

The facial expression is used to control the difficulty of the game.
<img src="https://github.com/llada60/Real-Time-Hand-Gesture-and-Face-Recognition-for-adaptive-game-control/blob/main/img/face.gif" width="700px">
